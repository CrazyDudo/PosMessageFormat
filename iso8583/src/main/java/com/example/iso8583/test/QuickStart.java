...
import com.example.iso8583.ext.tlv.parser.TlvParserFactory;
import com.example.iso8583.ext.tlv.parser.TlvParserType;
import com.example.iso8583.ext.tlv.parser.TlvValueFactory;
...
import com.example.iso8583.quickstart.special.SpecialField62;
...
import static com.example.iso8583.field.Iso8583FieldType.*;
...
public class QuickStart {
	...
	public static Iso8583DataHeader chapter2() {
		...
		Iso8583DataHeader header = new Iso8583DataHeader(
			...
			new Iso8583FieldType(FieldTypeValue.NUMERIC,10),
			// header	BCD编码，6个字节长度
			new Iso8583FieldType(FieldTypeValue.NUMERIC,12),
			// mti		BCD编码，2个字节长度
			new Iso8583FieldType(FieldTypeValue.NUMERIC,4),
			// bitmap	BCD编码，8个字节长度
			new Iso8583FieldType(FieldTypeValue.NUMERIC,16)
		);
		return header;
	}
...
//		message.setValue(32, "0123456789");		// NullPointerException 没有对当前索引做配置
	...
	public static void chapter4_1() {
		...
		Iso8583DataHeader header = new Iso8583DataHeader(
			new Iso8583FieldType(FieldTypeValue.NUMERIC,0),
			new Iso8583FieldType(FieldTypeValue.NUMERIC,0),
			new Iso8583FieldType(FieldTypeValue.NUMERIC,0),
			new Iso8583FieldType(FieldTypeValue.NUMERIC,0)
		);
		...
		facotry
				//1234506789
				.set(2, new Iso8583FieldType(FieldTypeValue.NUMERIC,10))
				//1234506789
				.set(3, new Iso8583FieldType(FieldTypeValue.BYTE_NUMERIC,5))
				//31323334353036373839
				.set(4, new Iso8583FieldType(FieldTypeValue.CHAR,10))
				//空格为将长度描述与数据描述分开表示，实际解析结果中没有空格
				//10 1234506789
				.set(5, new Iso8583FieldType(FieldTypeValue.LLVAR_NUMERIC,0))
				//05 1234506789
				.set(6, new Iso8583FieldType(FieldTypeValue.LLVAR_BYTE_NUMERIC,0))
				//10 31323334353637383930
				.set(7, new Iso8583FieldType(FieldTypeValue.LLVAR_CHAR,0))
				//0010 1234506789
				.set(8, new Iso8583FieldType(FieldTypeValue.LLLVAR_NUMERIC,0))
				//0005 1234506789
				.set(9, new Iso8583FieldType(FieldTypeValue.LLLVAR_BYTE_NUMERIC,0))
				//0010 31323334353036373839
				.set(10, new Iso8583FieldType(FieldTypeValue.LLLVAR_CHAR,0))
				//000010 1234506789
				.set(11, new Iso8583FieldType(FieldTypeValue.LLLLVAR_NUMERIC,0))
				//000005 1234506789
				.set(12, new Iso8583FieldType(FieldTypeValue.LLLLVAR_BYTE_NUMERIC,0))
				//000010 31323334353036373839
				.set(13, new Iso8583FieldType(FieldTypeValue.LLLLVAR_CHAR,0));
